...
plt.title("Top 10 Provider Types Medicare 2017")
plt.legend(labels, bbox_to_anchor=(1, 1), loc="upper left", fontsize=10)
plt.tight_layout()
plt.show()


# BAR CHART- MEAN CHRONIC DISEASE % ORDERED
...
# BAR CHART- PROVIDER TYPE/ RISK SCORE CORRELATION
